...
exports.restoreCodeBlocks = restoreCodeBlocks;
exports.extractDocusaurusComponents = extractDocusaurusComponents;
...
exports.safeTransform = safeTransform;
 ...
 */
function extractDocusaurusComponents(markdown) {
    const imports = [];
    const admonitions = [];
    const components = [];
    // Extract imports
 ...
 */
async function stringifyMarkdown(ast) {
    const processor = (0, unified_1.unified)().use(remark_stringify_1.default, {
        bullet: '-',
        fence: '`',
        fences: true,
 ...
 */
async function safeTransform(markdown, transformFn) {
    // Extract code blocks
