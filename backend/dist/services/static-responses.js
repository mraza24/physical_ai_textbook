...
exports.PERSONALIZATION_TIPS = exports.URDU_TRANSLATIONS = void 0;
exports.getPersonalizedContent = getPersonalizedContent;
exports.getUrduTranslation = getUrduTranslation;
exports.hasUrduTranslation = hasUrduTranslation;
// ========================================
// URDU TRANSLATIONS (Task 7 - Complete)
// ========================================
exports.URDU_TRANSLATIONS = {
 ...
 */
function getPersonalizedContent(originalContent, softwareBackground, hardwareExperience) {
    ...
    const tips = exports.PERSONALIZATION_TIPS[profileKey] || exports.PERSONALIZATION_TIPS['intermediate-basic'];
 ...
 */
function getUrduTranslation(chapterPath) {
    // Normalize path (remove leading slash if present)
    const normalizedPath = chapterPath.startsWith('/') ? chapterPath : '/' + chapterPath;
    return exports.URDU_TRANSLATIONS[normalizedPath] || null;
}
/**
 * Check if Urdu translation exists for a chapter
 */
function hasUrduTranslation(chapterPath) {
    const normalizedPath = chapterPath.startsWith('/') ? chapterPath : '/' + chapterPath;
    return normalizedPath in exports.URDU_TRANSLATIONS;
}
